...
public class SummaryDataDevicePerSecondToPhoenixSync {
    public static void main(String[] args) throws SQLException {
        ...
        try {
            for (int i = 0; i < 500000; i++) {
                //从mysql中查询出来数据
                String sql = "SELECT * FROM summary_data_device_per_second LIMIT 10000 OFFSET " + i * 10000;
                List<Map<String, Object>> mysqlDataList = fetchMySQLData(mysqlUrl, mysqlUser, mysqlPassword, sql);
                if (mysqlDataList.size() == 0) {
                    break;
                }
                // 插入进Phoenix表
                String upsertStatement = "UPSERT INTO \"air\".\"summary_data_device_per_second\" VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                ...
                for (Map map : mysqlDataList) {
                    ...
                    upsertStmt.setString(5, String.valueOf(map.get("type_name")));
                    upsertStmt.setInt(6, Integer.parseInt(String.valueOf(map.get("device_id"))));
                    upsertStmt.setString(7, String.valueOf(map.get("device_name")));
                    upsertStmt.setString(8, String.valueOf(map.get("total_active_power")));
                    upsertStmt.setString(9, String.valueOf(map.get("a_phase_voltage_value")));
                    upsertStmt.setString(10, String.valueOf(map.get("b_phase_voltage_value")));
                    upsertStmt.setString(11, String.valueOf(map.get("c_phase_voltage_value")));
                    upsertStmt.setString(12, String.valueOf(map.get("a_phase_current_value")));
                    upsertStmt.setString(13, String.valueOf(map.get("b_phase_current_value")));
                    upsertStmt.setString(13, String.valueOf(map.get("c_phase_current_value")));
